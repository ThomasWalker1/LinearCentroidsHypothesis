...
def create_poly_hyp_graph(poly, hyps, q=None, hyp_endpoints=None, dtype=torch.float64, verify=True, return_new_edges=False):

    new_edges = [] if return_new_edges else None
    G = nx.Graph()
