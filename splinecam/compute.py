...
def get_partitions_with_db(
    ...
    for current_layer in range(1,len(NN.layers)-1):
        ...
        out_cyc,out_idx,added_edges = graph.to_next_layer_partition_batched(
            cycles = out_cyc,
            Abw = Abw,
            NN = NN,
        ...
        new_edges[current_layer]=added_edges
        ...
        with torch.no_grad():
            ...
            Wb =  NN.layers[current_layer].get_weights(dtype=torch.float32)
    ...
    return out_cyc,endpoints,Abw,new_edges