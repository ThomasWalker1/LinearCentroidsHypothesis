...
def train(config: argparse.Namespace, device: torch.device):
    ...
    run = wb.init(project="lch-dino", config=config, name=run_name)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name", type=str, default="v2", choices=["v2, v3"]) #,"v3"
    parser.add_argument("--tokens", type=str, default="cls", choices=["cls", "all"]) #, "all"
